...
def main():
    if tinybot.pinylib.CONFIG.ROOM_NAME:
        room_name = tinybot.pinylib.CONFIG.ROOM_NAME
    else:
    ...
    if tinybot.pinylib.CONFIG.NICKNAME:
        bot.nickname = tinybot.pinylib.CONFIG.NICKNAME
    else:
